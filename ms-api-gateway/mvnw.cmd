...
@REM
@REM A menos que exigido pela lei aplicável ou acordado por escrito, O software 
@REM distribuído sob a Licença é distribuído em um
@REM BASE "COMO ESTÁ", SEM GARANTIAS OU CONDIÇÕES DE QUALQUER
@REM KIND, expresso ou implícito. Consulte a Licença para o Linguagem específica do 
...
echo Por favor, defina o JAVA_HOME variável em seu ambiente para corresponder ao >&2
